...
public class InquiryAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = inqObj.insertInquiries(request.getParameter("inquiryType"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = inqObj.updateInquiries(paras.get("hidInquiryIDSave").toString(), 
		paras.get("inquiryType").toString(), 
		paras.get("customerType").toString(), 
		paras.get("inquiryDesc").toString(), 
		paras.get("branchCode").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		Map paras = getParasMap(request); 
		String output = inqObj.deleteInquiries(paras.get("inquiryID").toString()); 
		response.getWriter().write(output);
	}
